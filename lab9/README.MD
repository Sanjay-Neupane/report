...
## Algorithm
        ...
        b. If region codes for endpoints are not zero and logical ANDing of them is also nonzero then line is invisible.
         Discard the line and move to step 9. 
...
![LINE CLIPPING PLOT](lab9/image/line clipping.png)

## Conclusion
In these lab, We successfully demonstrate the line clipping algorithm.
